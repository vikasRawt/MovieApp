import React, { useRef } from "react"; // used to catch a div/node in a react by making it's refrence
import {
...
const Carousel = ({ data, loading, endpoint, title}) => {
  ...
  const skItem = ()=>{                    //for skeleton Item this logic 
return(
        ...
        {!loading ? (
          <div className="carouselItems" ref={carouselContainer}>
            {data?.map((item) => {
              ...
              PosterFallback ;                                                //responsible for images shown in carousel
              return(
